...
$(document).ready ->
  ...
  provinceChange('#customer_profile_user_attributes_city', '#customer_profile_user_attributes_district')
  provinceChange('#customer_profile_province_code', '#customer_profile_city_code')
  provinceChange('#customer_profile_city_code', '#customer_profile_district_code')
