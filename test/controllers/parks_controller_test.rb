...
class ParksControllerTest < ActionController::TestCase
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post :create, park: { aboutme: @park.aboutme, name: @park.name, user_id: @park.user_id, website: @park.website }
    end
  ...
  test "should update park" do
    patch :update, id: @park, park: { aboutme: @park.aboutme, name: @park.name, user_id: @park.user_id, website: @park.website }
    assert_redirected_to park_path(assigns(:park))
  end
